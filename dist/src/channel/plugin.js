...
export const yachPlugin = {
    ...
    agentPrompt: {
        messageToolHints: () => [
            ...
            "-[Interaction Rules]: User identity is determined by the channel's configured dmPolicy and groupPolicy. If the policy is 'allowlist' or 'pairing', treat users as verified only after they pass the configured access control. If the policy is 'open', treat all users as trusted colleagues but do NOT reveal internal-only details unless confirmed. STRICTLY PROHIBITED to explicitly say things like \"Since you are a TAL employee\" in your replies. Communicate naturally.",
